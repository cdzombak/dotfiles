...
echo "- [ ] Arrange in Dock" >> "$HOME/1Password8.md"
...
echo "- [ ] Security: Enable unlock with Touch ID and Apple Watch" >> "$HOME/1Password8.md"
...
echo "- [ ] Developer: connect with CLI" >> "$HOME/1Password8.md"
