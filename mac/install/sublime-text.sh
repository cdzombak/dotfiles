...
echo "This might be a good point to generate a GitHub personal access token for this device, to be stored in the local login keychain:" $white
echo "https://github.com/settings/tokens" $cyan
