# from https://github.com/robbyrussell/oh-my-zsh/tree/master/plugins/golang , with customizations
...
__go_tool_complete() {
  ...
  __go_identifiers() {
      compadd $(godoc -templates ~/.zsh/golang-templates ${words[-2]} 2> /dev/null)
  }
  case ${words[2]} in
  doc)
    _arguments -s -w \
