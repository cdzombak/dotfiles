# usage: https://github.com/robbyrussell/oh-my-zsh/blob/master/plugins/nmap/README.md
# https://github.com/robbyrussell/oh-my-zsh/blob/master/plugins/nmap/nmap.plugin.zsh
